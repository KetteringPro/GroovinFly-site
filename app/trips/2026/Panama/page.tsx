  ...
  return (
    <main className="max-w-4xl mx-auto px-5 py-8 space-y-10">
      ...
      <section aria-label="Hero banner" className="relative rounded-2xl overflow-hidden">
        <Image
          src="/images/panama/panama-bungalow-bay.jpg"
      ...
      <section className="bg-white/5 border border-white/10 rounded-2xl p-7 shadow-md space-y-4">
        ...
        <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 gap-3 md:gap-4 my-2">
          <div className="relative w-full h-64 rounded-lg overflow-hidden">
            <Image src="/images/panama/panama-jungle-boardwalk.jpg" alt="Jungle boardwalk in Bocas del Toro" fill className="object-cover" />
          </div>
          <div className="relative w-full h-64 rounded-lg overflow-hidden">
            <Image src="/images/panama/panama-colorful-coast.jpg" alt="Colorful Panama coast" fill className="object-cover" />
          </div>
          <div className="relative w-full h-64 rounded-lg overflow-hidden">
            <Image src="/images/panama/panama-groovers-adventure.jpg" alt="GroovinFly travelers exploring Panama" fill className="object-cover" />
          </div>
        </div>
