...
const LINK_STAGECOACH_SHARED =
  process.env.NEXT_PUBLIC_STRIPE_LINK_STAGECOACH_SHARED ?? "#";
const LINK_STAGECOACH_SOLO =
  process.env.NEXT_PUBLIC_STRIPE_LINK_STAGECOACH_SOLO ?? "#";
// ----------------------------------------
