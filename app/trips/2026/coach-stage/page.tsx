  ...
  return (
    <main className="max-w-4xl mx-auto px-5 py-8 space-y-10">
      ...
      <section className="bg-white/5 border border-white/10 rounded-2xl p-7 shadow-md text-center">
        ...
        <p className="text-white/90 mb-2">💵 <strong>Shared Bed: $3,195</strong></p>
        <p className="text-white/90 mb-2">💵 <strong>Solo Bed: $4,095</strong></p>
        ...
        <div className="flex flex-wrap gap-3 justify-center">
          <a
            href="https://buy.stripe.com/fZu8wI3r1eaP6KBeA72Nq0J"
            target="_blank"
          ...
          <a
            href="https://buy.stripe.com/cNicMY5z93wb5GxbnV2Nq0K"
            target="_blank"
            rel="noopener noreferrer"
            className="bg-purple-700 hover:bg-purple-800 text-white font-semibold px-6 py-3 rounded-lg"
          >
